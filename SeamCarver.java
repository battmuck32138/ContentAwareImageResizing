...
techniques, i.e. cropping and scaling, the most interesting features
of the image are preserved.
REMOVES the ROW OR COLUMN OF PIXELS THAT ARE THE LEAST IMPORTANT TO THE IMAGE
WHILE LEAVING THE MORE IMPORTANT PARTS INTACT SO FAR AS SPACE PERMITS.
...
at the bottom right corner.  The color of a pixel is represented in RGB space,
using three integers ranging from 0 to 255.
...
public class SeamCarver {
    ...
    */
    ...
    //Removes a single horizontal seam from picture.
